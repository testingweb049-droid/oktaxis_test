...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Arrive in style with OKTaxis' wedding and event transfer service in Manchester. Elegant vehicles, professional chauffeurs, and seamless group travel.",
      ...
      <StructuredData
        data={[
          ...
          generateServiceSchema({
            ...
            description: "Wedding car hire service with professional chauffeurs. Elegant vehicles, professional drivers, and seamless group travel for weddings and events.",
