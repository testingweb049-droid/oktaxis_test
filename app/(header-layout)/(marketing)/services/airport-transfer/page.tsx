...
export default function AirportTransfer() {
  return (
    <>
      <Seo
        title="Manchester Airport Transfers | OKTaxis"
        description="Book luxury airport transfers in Manchester with OKTaxis. 24/7 chauffeur service, real-time flight tracking & complimentary waiting time included."
        url="https://oktaxis.co.uk/services/airport-transfer"
        image="https://oktaxis.co.uk/images/airport-transfer.png" // ✅ Make sure this is a valid OG image path
      />
      <HeroSection2
      ...
      <ImageTextSection
        ...
        title={
          <span className="text-3xl md:text-4xl font-bold">
            Executive {' '}
            <span className="text-brand text-3xl md:text-4xl font-bold">Airport</span>{' '}
            Transfer
          </span>
        }
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center  mb-12">
            Our Service <span className="text-brand text-3xl md:text-4xl font-bold">Features</span>{' '}
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600">
                We offer a generous free waiting period in case of delayed
                flights.
              </p>
            </div>
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600">
                Your chauffeur will handle all baggage, helping you to get
                settled quickly after landing.
              </p>
            </div>
            <div className="bg-gray-50 p-8 rounded-xl">
              <div className="bg-black w-16 h-16 rounded-full flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">
                Available for any flight, day or night, to Manchester and other
                UK airports.
              </p>
            </div>
          </div>
