            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-5 text-gray-600">
                <p className="text-lg leading-relaxed">
                  OK Taxis is a Manchester-based private hire company dedicated to delivering a premium travel experience. Our journey began with a simple goal: to offer a first-class chauffeur service that combines luxury, reliability and local expertise.
                </p>
                <p className="text-lg leading-relaxed">
                  At OK Taxis, we believe that details matter. Punctuality, safety and transparent pricing are the cornerstones of our service. Our drivers arrive on time, in uniform, and ready to assist you with your luggage and needs.
                </p>
              </div>
            </div>
          </div>
