          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-5 text-gray-600">
                ...
                <p className="text-lg leading-relaxed">
                  At OK Taxis, we believe that details matter. Punctuality, safety and transparent pricing are the cornerstones of our service. Our drivers arrive on time, in uniform, and ready to assist with your luggage and needs. We maintain our vehicles to the highest standards of cleanliness and safety, and every ride is covered by real-time GPS tracking for extra assurance. Because we value honesty, there are no hidden fees – the price we quote is the price you pay, with no surprises at the end of your journey. We even offer free waiting time and flexible cancellation policies to give you extra peace of mind.
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6 text-gray-600">
                <p className="text-lg leading-relaxed">
                  Serving Manchester and nearby cities like Liverpool, Leeds, and beyond, OK Taxis prides itself on a reputation for excellence. Whether you’re a busy executive, a visitor exploring the city, or a local resident heading out for a special occasion, you can rely on our personal approach and 24/7 support. We’re not just a transportation company – we’re your partner in travel, focused on making every journey safe, smooth and enjoyable. Experience our trusted luxury chauffeur service for yourself and discover why so many clients keep choosing OK Taxis for their private hire needs.
                </p>
                {/* <p className="text-lg leading-relaxed">
