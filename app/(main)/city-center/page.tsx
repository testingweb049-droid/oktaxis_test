        ...
        cards={[
          ...
          },
          {
            ...
            children: (
              <ul className="list-disc pl-5 space-y-2 text-text-gray text-sm sm:text-base md:text-lg lg:text-2xl leading-relaxed">
                <li>
                  <span className="font-semibold">Corporate &amp; Financial:</span>{" "}
        ...
        services={[
          {
            icon: (
              <svg
                ...
                className="h-6 w-6 md:h-8 md:w-8 text-primary-yellow"
                aria-hidden="true"
              >
                <path
        ...
        faqs={[
          {
            ...
            answer:
              "Yes. Prices vary based on the vehicle class (E-Class vs XL Passenger Van). Contact us for a fixed quote. We offer competitive rates for city-to-city transfers compared to last-minute train fares.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes. A taxi is a curbside pickup. Our executive chauffeur service includes a dedicated driver, a guaranteed high-spec Mercedes vehicle, a meet-and-greet service, and flight tracking.",
          },
          {
