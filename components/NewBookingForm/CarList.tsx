      ...
      {fleets.map((item) => {
        ...
        if (category === "hourly") {
          ...
          if (item.name === "Economy") {
            price = distance <= 30 ? 52 : 52 + (distance - 30) * 1.4;
          } else if (item.name === "Executive") {
            price = distance <= 34 ? 62 : 62 + (distance - 34) * 1.5;
          } else if (item.name === "Executive Premium") {
            price = distance <= 36 ? 87 : 87 + (distance - 36) * 2.2;
          } else if (item.name === "Luxury Van") {
            price = distance <= 38 ? 95 : 95 + (distance - 38) * 2.3;
          }
        }
