  ...
  return (
    <div ref={containerRef} className="relative max-w-5xl">
      ...
      <input
        ...
        className="w-full px-3 py-2 border rounded-lg text-sm shadow-sm bg-white cursor-pointer text-black"
            ...
            {selectedDate && (
              ...
              >
                <div className="flex items-center gap-1 min-w-0">
                  ...
                  <span className="text-2xl font-bold flex-shrink-0">:</span>
                  {/* Minute Select */}
                  <div className="flex items-center bg-zinc-800 rounded-sm px-1 py-0.5">
                    <span className="font-bold text-2xl flex-shrink-0">
                  ...
                  <div
                    className="bg-zinc-800 rounded-sm px-1 py-0.5 font-bold text-sm cursor-pointer hover:bg-zinc-700 flex-shrink-0"
                ...
                <Button
                  ...
                  className="bg-brand text-black text-sm font-bold hover:bg-brand px-2 py-1 whitespace-nowrap flex-shrink-0"
                >
                  Apply
                </Button>
              </div>
